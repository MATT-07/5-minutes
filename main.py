...
lv1 = True
lv2 = False #variables pour savoir dans quel niveau on se trouve si = True, niveau actuel
...
pyxel.run(update, draw_lv1) #fonction d'affichage des graphismes en fonction du niveau actuel
